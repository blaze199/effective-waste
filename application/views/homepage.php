		...
		<div id="box_wrapper">
			...
			<section id="about" class="ls section_padding_top_100 section_padding_bottom_150">
				<div class="container">
					...
					<?php echo strtoupper($system_abbr); ?> is a company serving individuals and businesses in India with their computers and electronics upgrade needs, accepting computers and electronics waste in any conditions.
				</p>
						...
						<div class="col-md-4 col-sm-6">
							<div class="media small-teaser teaser inline-block">
								...
								<div class="media-body media-middle">
									<span class="fontsize_20 medium black">+91 8910273116</span>
									<br>
									<span class="small-text small-spacing lightgrey">Tcet Mumbai</span>
								</div>
							</div>
						</div>
						<div class="col-md-4 col-sm-6">
							<div class="media small-teaser teaser inline-block">
								...
								<div class="media-body media-middle">
									...
									<br>
									<span class="small-text small-spacing lightgrey">e.waste@tcetmumbai.in</span>
								</div>
							</div>
						</div>
