...
class Query_model extends CI_Model {
    ...
    function sendNotification($code){
        ...
        $message='Hello '.$name. '? Your dispose request has been recieved successfully. Your dispose ID is '.$code.'. Please pay INR: '. $this->formatMoney($transaction_total,true). ' before '.date("m/d/Y",$collection_date).' to approve your disposes.';
        //send message
        $curl = curl_init();
